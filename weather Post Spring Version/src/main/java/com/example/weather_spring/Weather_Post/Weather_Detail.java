package com.example.weather_spring.Weather_Post;
...
public class Weather_Detail implements Runnable{
    private final PrintWriter out;
    private final String city;
    private final String ShareURL;
    private final JSONObject objectMain;
    private final String[] Days;
    private final String need3Hour;
    ...
    public Weather_Detail(PrintWriter out, String city, String ShareURL,JSONObject objectMain,String[] Days,String need3Hour){
        this.out = out; this.city=city; this.ShareURL=ShareURL; this.objectMain=objectMain; this.Days=Days; this.need3Hour=need3Hour;
    }
    ...
    public void run(){
        ...
        out.write("<h4 style=\"text-align:center\">复制该链接可分享天气详情表：" + ShareURL + "</h4><br><br>");
        ...
        for (int day = 1; day <= 7; day++) {
            if (Arrays.asList(Days).contains("day" + day)) {
                ...
                if (rows == 13) {
                    ...
                    Iterator<Object> nextTemp = hoursD.iterator();
        ...
        MainApp.addInfo("天气详情表打印完成！");
        MainApp.addInfo("样表URL地址如下："+ShareURL);
    }
}
